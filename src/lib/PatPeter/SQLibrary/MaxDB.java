...
public class MaxDB extends Database {
    ...
    public MaxDB(Logger log, String prefix, String database, String username, String password) {
    ...
    public MaxDB(Logger log, String prefix, String hostname, int port, String database, String username, String password) {
        super(log, prefix, "[MaxDB] ");

...
public class Mongo extends Database {
    ...
    public Mongo(Logger log, String prefix, String database, String username, String password) {
    ...
    public Mongo(Logger log, String prefix, String hostname, int port, String database, String username, String password) {
        super(log, prefix, "[MaxDB] ");

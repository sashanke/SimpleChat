...
public class MySQL extends Database {
    ...
    public enum Statements implements StatementEnum {
        ...
        SELECT("SELECT"), INSERT("INSERT"), UPDATE("UPDATE"), DELETE("DELETE"), DO("DO"), REPLACE("REPLACE"), LOAD("LOAD"), HANDLER("HANDLER"), CALL(
                "CALL"),

        // Data definition statements
        CREATE("CREATE"), ALTER("ALTER"), DROP("DROP"), TRUNCATE("TRUNCATE"), RENAME("RENAME"),

        // Transactional and Locking Statements
        START("START"), COMMIT("COMMIT"), SAVEPOINT("SAVEPOINT"), // http://dev.mysql.com/doc/refman/5.6/en/implicit-commit.html#savepoint
        ...
        // Utility Statements
        DESCRIBE("DESCRIBE"), EXPLAIN("EXPLAIN"), HELP("HELP"), USE("USE");

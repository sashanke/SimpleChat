...
public class mSQL extends Database {
    ...
    public mSQL(Logger log, String prefix, String database, String username, String password) {
    ...
    public mSQL(Logger log, String prefix, String hostname, int port, String database, String username, String password) {
        super(log, prefix, "[mSQL] ");

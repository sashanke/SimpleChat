...
public class Ovrimos extends Database {
    ...
    public Ovrimos(Logger log, String prefix, String username, String password) {
    ...
    public Ovrimos(Logger log, String prefix, String hostname, int port, String username, String password) {
        super(log, prefix, "[Ovrimos] ");

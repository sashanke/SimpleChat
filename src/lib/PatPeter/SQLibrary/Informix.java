...
public class Informix extends Database {
    ...
    public Informix(Logger log, String prefix, String database, String username, String password) {
    ...
    public Informix(Logger log, String prefix, String hostname, int port, String database, String username, String password) {
        super(log, prefix, "[Informix] ");

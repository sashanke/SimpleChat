...
public class DB2 extends Database {
    ...
    public DB2(Logger log, String prefix, String database, String username, String password) {
    ...
    public DB2(Logger log, String prefix, String hostname, int port, String database, String username, String password) {
        super(log, prefix, "[DB2] ");
